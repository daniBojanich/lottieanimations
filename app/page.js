  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <p>{language === "es" ? "Gráficos representativos de diversos servicios, siguiendo el estilo gráfico de su marca." : "Graphics that represent your services, following your brand aesthetic."}</p>
